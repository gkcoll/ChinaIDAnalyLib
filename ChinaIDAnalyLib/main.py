...
class IDError(Exception):
    ...
    def __str__(self):
        return "You enterd a invalid and illegal ID: " + str(self.value) + \
               ".\nPlease check your enterd ID. It should have 18 DIGITS and the verification code is CORRECT."
